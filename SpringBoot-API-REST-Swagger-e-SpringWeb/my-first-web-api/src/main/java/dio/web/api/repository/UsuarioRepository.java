...
public class UsuarioRepository {
    ...
    public List<Usuario> findAll(){
        ...
        usuarios.add(new Usuario(3, "calebe", "abobora"));
        usuarios.add(new Usuario(4, "bigger", "abobora"));
        return usuarios;
    }

    public Usuario findById(Integer id){
        System.out.println(String.format("FIND/id - Recebendo o id: %d para localizar um usuário", id));
        return new Usuario(5,"gleyson","password");
    }

    public Usuario findByUsername(String username){
        System.out.println(String.format("FIND/username - Recebendo o usernamae: %s para localizar um usuário", username));
        return new Usuario(6, "calebe","password");
    }
}
